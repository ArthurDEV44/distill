...
| Ajouter Tree-sitter pour Go | Haute | 2 jours | AST précis Go | **FAIT** |
...
| Ajouter Tree-sitter pour Swift | Haute | 2 jours | AST précis Swift | **FAIT** |
...
| Implémenter `code-skeleton` | Moyenne | 2 jours | Vue d'ensemble code | **FAIT** |
